...
import type { ConversationType } from '../../conversation/model/Conversation';
import type { MessageType } from '../../message/model/Message';
import type { SharedFile } from '../../file/model/SharedFile';
import type { Task } from '../../task/model/Task';
import type { Team } from '../../team/model/Team';
import type { User } from '../../user/model/User';
import type { Channel } from '../../channel/model/Channel';
import type { Department } from '../../company/model/Department';
...
export type { Channel, Department, Task, Team, User };
