...
import type { AttendanceDay, LeaveType, Holiday } from '../../../entities/attendance/model/Attendance';
import { LEAVE_TYPE_LABELS } from '../../../entities/attendance/model/Attendance';
