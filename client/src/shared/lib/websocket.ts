import type { Announcement, Reaction, WsMessage, SharedFile } from '../../entities';
...
meeting_cancelled: {
  ...
  data: { meeting: { id: number } };
  timestamp?: string;
};
meeting_note_added: {
  type: 'meeting_note_added';
  data: { note: any; meetingId: number };
  timestamp?: string;
};
...
meeting_note_deleted: {
  ...
  data: { noteId: number; meetingId: number };
  timestamp?: string;
};
meeting_reminder_set: {
  type: 'meeting_reminder_set';
  data: { reminder: any; meetingId: number };
  timestamp?: string;
};
meeting_reminder_deleted: {
  type: 'meeting_reminder_deleted';
  data: { reminderId: number; meetingId: number };
  timestamp?: string;
};
...
meeting_attendee_updated: {
  ...
  data: { attendee: any; meetingId: number };
  timestamp?: string;
};
...
meeting_attachment_added: {
  type: 'meeting_attachment_added';
  data: { attachment: any; meetingId: number };
  timestamp?: string;
};
meeting_attachment_deleted: {
  type: 'meeting_attachment_deleted';
  data: { attachmentId: number; meetingId: number };
  timestamp?: string;
};
}
