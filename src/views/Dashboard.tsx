...
const Dashboard = () => {
  ...
  const handleSelectView = (next: AppView) => {
    ...
    setView(next);
    // Close the mobile nav drawer whenever a view is picked.
    ...
    <main className="workspace-shell">
      ...
      >
                ...
                {activeConversation ? (
                  <>
                    ...
                    <p className="composer-hint">
                      ...
                      for a new line · Type <kbd>@</kbd> to mention someone ·{" "}
                      <kbd>⌘K</kbd> to search · Click <kbd>🎤 Voice</kbd> to
                      record
                    </p>
                  </>
                ) : (
        ...
        {view === "home" && activeConversation && (
          <aside className={`members-panel ${showMembers ? "" : "hidden"}`}>
            <header>
              <h2>
